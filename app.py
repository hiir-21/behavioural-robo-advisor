...
# ================= PAGE 2 : Q3–Q14 =================
    ...
    ask("Q3","Q3. When new information contradicts your investment thesis, you usually:",
    ...
    ask("Q4","Q4. You bought a stock at ₹1,500; it now trades at ₹1,000. Which thought best reflects your reaction?",
    ...
    ask("Q5","Q5. When deciding whether to sell an investment, you rely most on:",
    ...
    ask("Q6","Q6. After a stock performs very well over the last few months, you believe:",
    ...
    ask("Q7","Q7. Which presentation makes you more comfortable investing?",
        ["A. “90% success rate”","B. “Only 10% failure rate”",
         "C. Both equally","D. Absolute return numbers",
         "E. Long-term historical averages"],"bias")

    ask("Q8","Q8. After repeated news about market crashes, you:",
    ...
    ask("Q9","Q9. Which situation feels most uncomfortable to you as an investor?",
    ...
    ask("Q10","Q10. After a series of profitable trades, you plan your next investment by:",
    ...
    ask("Q11","Q11. A stock is trending heavily on social media and business news. You:",
    ...
    ask("Q12","Q12. You have one stock with large gains and one with losses. You:",
    ...
    ask("Q13","Q13. You keep an old investment mainly because:",
    ...
    ask("Q14","Q14. When markets move sharply in a single day, you tend to:",
